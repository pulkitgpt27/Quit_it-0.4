...
public class ReportActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        $face_image = (ImageView) findViewById(R.id.report_activity_image);
        $image_text = (TextView) findViewById(R.id.image_text);

        $progress_text_view = (TextView) findViewById(R.id.report_progress_text_view);
        $progress_parent = (LinearLayout) findViewById(R.id.report_progress_parent);
        $progress_bar = (ProgressBar) findViewById(R.id.report_progress_bar);
